...
void UART_SendByte(UART_NumberTypeDef NumberTypeDef, unsigned char u8data);
void UART_SendStr(UART_NumberTypeDef NumberTypeDef, unsigned char *str, unsigned int u16length);
